...
curl --retry 3 https://yices.csl.sri.com/releases/2.6.2/yices-2.6.2-x86_64-pc-linux-gnu-static-gmp.tar.gz --output yices.tar.gz
tar -xf yices.tar.gz

mkdir -p "$INSTALL_DIR"/bin
mv z3-4.4.1-x64-ubuntu-14.04/bin/* "$INSTALL_DIR"/bin
mv yices-2.6.2/bin/* "$INSTALL_DIR"/bin
